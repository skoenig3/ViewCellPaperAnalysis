...
for i=1:nvar
    ...
    switch type
        case 0 % neuron
            ...
            nexFile.neurons{neuronCount,1}.timestamps = round(1000*fread(fid, [n 1], 'int32')./nexFile.freq); %edited 4/21/16 SDK
        ...
        case 3 % waveform
            ...
            fseek(fid, offset, 'bof');
            nexFile.waves{waveCount,1}.timestamps = round(1000*fread(fid, [n 1], 'int32')./nexFile.freq); %edited 4/21/16 SDK
